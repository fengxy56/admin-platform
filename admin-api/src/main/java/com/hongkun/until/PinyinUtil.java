...
public class PinyinUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getPinyin("冯晓洋", ""));
//        System.out.println(getPinyin("冯晓洋", " "));
//        System.out.println(getPinyinInitials("冯晓洋"));
        //System.out.println(getCnASCII("冯晓洋"));
     ...
     * @return {@link String}
     */
    public static String getPinyinBySeparator(String text, String separator) {
        String pinyin = getPinyin(text,separator);
